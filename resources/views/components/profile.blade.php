        ...
        <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                   aria-controls="profile" aria-selected="false">Phương tiện</a>
            </li>
        </ul>
            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="text-center mb-4">
                    <figure class="avatar avatar-xl mb-4">
                        <img src="" class="image-avatar-user rounded-circle" alt="image">
                    </figure>
                    <h5 class="mb-1 full-name-user"></h5>
                    <small class="text-muted font-italic">Last seen: Today</small>
                </div>
                <p class="text-muted about-user"></p>
                <div class="mt-4 mb-4">
                    <h6>Phone</h6>
                    <p class="text-muted phone-user"></p>
                </div>
                <div class="mt-4 mb-4">
                    <h6>City</h6>
                    <p class="text-muted address-user"></p>
                </div>
                <div class="mt-4 mb-4">
                    <h6 class="mb-3">Mạng xã hội</h6>
                    <ul class="list-inline social-links">
                        <li class="list-inline-item">
                            <a href="#" class="btn btn-floating btn-facebook" data-toggle="tooltip"
                               title="Facebook">
                                <i class="mdi mdi-facebook"></i>
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a href="#" class="btn btn-floating btn-twitter" data-toggle="tooltip" title="Twitter">
                                <i class="mdi mdi-twitter"></i>
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a href="#" class="btn btn-floating btn-instagram" data-toggle="tooltip"
                               title="Instagram">
